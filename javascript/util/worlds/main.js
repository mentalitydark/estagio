...
const village = [
    ...
    new Block(1928, 1407, 1943, 1408, "home_master", false, "door"),
    new Block(1768, 1439, 1783, 1440, "home_master", false, "door"),
    new Block(1768, 1311, 1783, 1312, "home_master", false, "door"),
    new Block(1928, 1247, 1945, 1248, "home_master", false, "door"),
    new Block(1736, 1183, 1751, 1184, "home_master", false, "door"),
];
